...
impl AdminManager {
    ...
    pub fn request_verification_email(self: &mut AdminManager) -> EmptyResult {
        self.0.request_verification_email().into()
    }

    pub fn verify_email(self: &mut AdminManager, verification_code: String) -> EmptyResult {
        self.0.verify_email(verification_code).into()
    }
}
